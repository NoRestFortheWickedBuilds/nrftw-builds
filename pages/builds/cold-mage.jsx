...
export default function ColdMage() {
    return (
        <div style={{ backgroundImage: "url('/background/background-image.jpeg')", backgroundSize: "cover", minHeight: "100vh", color: "white", padding: "20px" }}>
            ...
            <h4 style={ color: "silver" }>Weapon 1: Endless Winter</h4>
            <ul>
            ...
            <h4 style={ color: "silver" }>Helmet: Cloth</h4>
            <ul>
            ...
            <h4 style={ color: "silver" }>Pants: Cloth</h4>
            <ul>
            ...
            <h4 style={ color: "silver" }>Ring 3: Plagued Ring</h4>
            ...
            <h4 style={ color: "silver" }>Faith: 55</h4>
            <h4 style={ color: "silver" }>Focus: 20</h4>
            <h4 style={ color: "silver" }>Equip Load: 12</h4>
